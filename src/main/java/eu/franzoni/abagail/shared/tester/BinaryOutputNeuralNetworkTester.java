 ...
 * @date 2013-03-05
 */
public class BinaryOutputNeuralNetworkTester implements Tester {

    private NeuralNetwork network;
    private TestMetric[] metrics;

    public BinaryOutputNeuralNetworkTester(NeuralNetwork network, TestMetric ... metrics) {
    ...
    public void test(Instance[] instances) {
        for (int i = 0; i < instances.length; i++) {
            ...
            Instance actualOne = new Instance(actual.getDiscrete());
