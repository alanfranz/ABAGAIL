...
public class NeuralWinesExperiments {
    ...
    public static void main(String[] args) {
        ...
        final List<Integer> populationSizes = Arrays.asList(400, 4000, 40000);
        final List<Integer> mateFactors = Arrays.asList(100, 200, 400);
        final List<Integer> mutateFactors = Arrays.asList(100, 200, 400);
        ...
        final List<Double> temperatureFactors = Arrays.asList(1e5, 1e10, 1e16);
